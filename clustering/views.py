...
def index(request):
    ...
    for i in atribut_kondisi_rumah :
        ...
        desc.append({'nama' : i, 'max' : max_data, 'min' : min_data, 'mean' : mean_data, 'count' : count_data})
    ...
    context = {
        ...
        'atribut_kondisi_rumah':atribut_kondisi_rumah,
        'atribut_aset': atribut_aset,
        'desc'     : desc
    }
...
def proses(request):
    label = ['IDJTG']
    atribut_kondisi_rumah = ['luas_bangunan','luas_lahan']
    atribut_aset = ['gas','kulkas','ac', 'pemanas_air',
                    'telepon_rumah',
                    'tv','perhiasan','komputer','sepeda',
               'motor','mobil','perahu','motor_tempel',
               'perahu_motor','kapal','lahan','sapi','kerbau',
               'kuda','babi','kambing','unggas']
    atribut = []
    for i in atribut_kondisi_rumah :
        atribut.append(i)
    for i in atribut_aset :
